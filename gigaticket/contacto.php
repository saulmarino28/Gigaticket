    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mr-auto ">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="contacto.php"><strong>Contacto</strong><span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
   		...
   		<div class="row justify-content-center ">
   			<div class="col-sm m-3">
    				...
    				<div class="row mt-3 mx-2">
						<div class="col-sm-12">
						   <h3>
					          Si usted tiene alguna duda, queja o sugerencia por favor envie un mensaje al siguiente correo:
					          <address>gigaticket28@gmail.com</address>
				           </h3>
						</div>
					</div>
   				</div> 
