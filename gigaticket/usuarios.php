    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mr-auto ">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="usuarios.php"><strong>Usuarios</strong><span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
				      ...
				      <div class="row justify-content-center mt-3 mx-2">
				        <div class="col-md-5">
				               <div class="form-group">
				                 ...
				                 <input type="email" class="form-control" id="email" placeholder="Enter nombre de usuario" name="email" required>
				                 <div class="valid-feedback">Valido.</div>
				                 <div class="invalid-feedback">Por favor escribe unemail valido.</div>
				               </div>
				               <div class="form-group">
				                 <label for="psw">Conntraseña:</label>
