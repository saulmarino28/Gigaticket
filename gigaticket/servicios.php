...
<body >
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mr-auto ">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="servicios.php"><strong>Servicios</strong><span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
  ...
  <!-- Start Container-->
    <div class="container ">
  		<a href="http://localhost/gigaticket/payMethod_ss.php">Desea adquirir los servicios de Gigaticket</a>
